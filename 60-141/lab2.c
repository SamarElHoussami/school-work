/*	
	...
	Objective: Display interactive menu and allow user to call 5 recursive functions
	...
	*********************************/
	int funcFib(int a)
	{
		...
		if ((a == 0) || (a == 1)) return a;
			...
			return funcFib(a - 1) + funcFib(a - 2);
	}
